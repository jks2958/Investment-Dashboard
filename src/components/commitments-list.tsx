...
export function CommitmentsList() {
  ...
  const [editing, setEditing] = React.useState<Commitment | undefined>();
  ...
  if (!commitments || commitments.length === 0) {
    return (
      <EmptyState
        ...
        description="Add costs you know are coming — tuition, a wedding, a car replacement — to see what to set aside each month."
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <DeleteButton
                    ...
                    detail={`${formatCurrency(math.totalAmount)} due ${formatDateShort(
                      commitment.dueOn,
                    )}`}
                    onConfirm={() => deleteCommitment.mutate(commitment.id)}
                  />
                </div>
              </div>
